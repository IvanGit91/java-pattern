...
this is most likely a composite. If methods of these classes delegate the work to child objects of the tree and do it
via the base class/interface of the hierarchy, this is definitely a composite.
*/

import structural.composite.sample1.editor.ImageEditor;
import structural.composite.sample1.shapes.Circle;
import structural.composite.sample1.shapes.CompoundShape;
import structural.composite.sample1.shapes.Dot;
import structural.composite.sample1.shapes.Rectangle;
